...
public class StudentGroup implements StudentArrayOperation {
	...
	public void add(Student student, int index) {
		...
		this.students[i+1]=null;// Add your implementation here
	...
	public void removeFromIndex(int index) {
		...
		this.students[index]=null;// Add your implementation here
	}
	...
	public void removeToIndex(int index) {
		...
		this.students[j+1]=null;// Add your implementation here
	}
			...
			for(int j=0;j<n-i-1;j++)
				if((this.students[j]).isGreaterThan(this.students[j+1]))
				{
				    ...
				    this.students[i]=this.students[j];
		    		    this.students[j]=student;	// Add your implementation here
